            ...
            success: function(data) {
                ...
                if (data.length === 0) {
                    ...
                    $.each(data, function(index, row) {
                        ...
                        // 09:45
                        else if ($row['l_leave_start_time'] == '10:00:00' && $row[
                                'l_remark'] == '09:45:00') {
                            startTime = '09:45:00';
                        }
                        // 10:45
                        else if ($row['l_leave_start_time'] == '11:00:00' && $row[
                                'l_remark'] == '10:45:00') {
                            startTime = '10:45:00';
                        }
                        // 11:45
                        ...
                        // 13:10
                        else if ($row['l_leave_start_time'] == '13:30:00' && $row[
                                'l_remark'] == '13:10:00') {
                            startTime = '13:10:00';
                        }
                        // 13:40
                        else if ($row['l_leave_start_time'] == '14:00:00' && $row[
                                'l_remark'] == '13:40:00') {
                            startTime = '13:40:00';
                        }
                        // 14:10
                        else if ($row['l_leave_start_time'] == '14:30:00' && $row[
                                'l_remark'] == '14:10:00') {
                            startTime = '14:10:00';
                        }
                        // 15:10
                        else if ($row['l_leave_start_time'] == '15:30:00' && $row[
                                'l_remark'] == '15:10:00') {
                            startTime = '15:10:00';
                        }
                        // 15:40
                        else if ($row['l_leave_start_time'] == '16:00:00' && $row[
                                'l_remark'] == '15:40:00') {
                            startTime = '15:40:00';
                        }
                        // 16:10
                        else if ($row['l_leave_start_time'] == '16:30:00' && $row[
                                'l_remark'] == '16:10:00') {
                            startTime = '16:10:00';
                        }
                        // 16:40
