  ...
  border: none;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarText">
                        <ul
                            class="navbar-nav d-flex align-items-center me-auto mb-2 mb-lg-0 d-lg-none d-xl-none d-xxl-none">
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="user_leave.php"><?php echo $strStatistics; ?></a>
                                    </li>
                                    <!-- <li><a class="dropdown-item" href="user_history.php">ประวัติการลาและการมาสาย</a></li> -->
                                </ul>
                            </li>
                            <!-- ตรวจสอบ userCode เพื่อแสดงเมนูเฉพาะ -->
                            <?php if (isset($userCode) && ($userCode == '6608418' || $userCode == '5810302')): ?>
                            <li class="nav-item">
                                <a class="nav-link" href="admin_employee_leave_form.php"
                                    style="color: white;">ยื่นใบลาย้อนหลัง</a>
                            </li>
                            <?php endif; ?>
                        </ul>
            ...
            <!-- /* edit by pim */ -->
            <!-- Modal เปลี่ยนเบอร์โทรศัพท์ -->
            <div class="modal fade" id="changeTelPhone" tabindex="-1" aria-labelledby="changeTelPhoneLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="changeTelPhoneLabel">เปลี่ยนเบอร์โทรศัพท์</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form id="changeTelForm">
                                <div class="mb-3">
                                    <label for="newPhone" class="form-label">เบอร์โทรศัพท์ใหม่</label>
            ...
            $(document).ready(function() {
                ...
                $("#changeTelForm").submit(function(e) {
                    e.preventDefault();
                    var formData = $(this).serialize();

                    $.ajax({
                        type: "POST",
                        url: "u_change_telphone.php",
                        data: formData,
                        dataType: "json",
                        success: function(response) {
