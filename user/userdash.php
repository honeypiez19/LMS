    ...
    AND e_workplace = :workplace";
            ...
            <div class="table-responsive">
                <table class="table table-hover" style="border-top: 1px solid rgba(0, 0, 0, 0.1);" id="leaveTable">
                    ...
                    <tbody>
                        ...
                        // Bind the limit and offset parameters - ต้องใช้ $itemsPerPage ที่รับค่ามาจาก URL
            ...
            <div class="container-fluid mt-3">
                <div class="row align-items-center">
                    <!-- ปุ่มเลื่อนหน้า พร้อมตัวเลือกจำนวนรายการต่อหน้า -->
                    <div class="col-lg-7 col-md-12 mb-3 mb-lg-0">
                        <!-- ปุ่มเลื่อนหน้า -->
                        <div class="pagination-controls mb-3 mb-md-0">
                            <nav aria-label="Page navigation">
                                <ul
                                    class="pagination pagination-sm flex-wrap justify-content-center justify-content-md-start mb-0">
