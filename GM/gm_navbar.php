        ...
        if ($image) {
            ...
            if ($stmt = $conn->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    location.href = 'gm_dashboard.php';
                </script>";
                } else {
                ...
                <ul class="navbar-nav d-flex align-items-center me-auto mb-2 mb-lg-0 d-lg-none d-xl-none d-xxl-none">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="gm_leave.php"><?php echo $strStatistics; ?></a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="gm_leave_request.php"><?php echo $strEmpLeaveForm; ?></a>
                            </li>
                            <li><a class="dropdown-item" href="gm_employee_leave.php"><?php echo $strEmpLeaveSta; ?></a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="gm_employee_attendance.php"><?php echo $strEmpLeaveLate; ?></a>
                            </li>
                        </ul>
                    </li>
