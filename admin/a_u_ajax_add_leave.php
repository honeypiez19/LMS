...
// กำหนดค่าเริ่มต้น
        ...
        if ($result) {
            ...
            if (in_array($levelApporve, ['leader', 'chief', 'subLeader'])) {
                ...
                $proveStatus3 = 7;
            } elseif ($levelApporve === 'GM') {
                $proveStatus  = 6;
                $proveStatus2 = 6;
                $proveStatus3 = 7;
            } elseif ($levelApporve === 'admin') {
                $proveStatus  = 6;
                $proveStatus2 = 6;
                $proveStatus3 = 6;
            }
...
l_level, l_approve_status2, l_workplace, l_time_remark, l_approve_status3, l_time_remark2)
VALUES (
...
:level, :proveStatus2, :workplace, :timeRemark, :proveStatus3, :timeRemark2)");
