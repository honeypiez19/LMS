            ...
            $(document).ready(function() {
                ...
                $('#leaveType').on('change', function() {
                    ...
                    if (selectedDate) {
                        ...
                        $.ajax({
                            url: 'a_u_ajax_get_leave_balance.php',
                            type: 'POST',
                            data: {
                                leaveType: leaveType,
                                userCode: userCode,
                ...
                $('#urgentLeaveType').on('change', function() {
                    ...
                    if (selectedDate) {
                        ...
                        $.ajax({
                            url: 'a_u_ajax_get_urgent_leave_balance.php',
                            type: 'POST',
                            data: {
                                leaveType: leaveType,
                                userCode: userCode,
                ...
                $('#leaveForm').submit(function(e) {
                    ...
                    // เช็คลาซ้ำ
                    $.ajax({
                        url: 'a_u_ajax_chk_leave_double.php',
                        type: 'POST',
                        data: {
                            startDate: startDate,
                            startTime: startTime,
...
>>>>>>> Stashed changes
                ...
                $('#urgentLeaveForm').submit(function(e) {
                    ...
                    $.ajax({
                        url: 'a_u_ajax_chk_urgent_leave_double.php',
                        type: 'POST',
                        data: {
