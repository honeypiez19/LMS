...
ORDER BY li.l_create_datetime DESC";
                        ...
                        <div class="d-flex align-items-center me-3">
                            <form action="" method="GET" class="d-flex align-items-center"
                                ...
                                <input type="number" id="jumpToPage" name="page"
                                    class="form-control form-control-sd mx-2" min="1" max="<?php echo $totalPages; ?>"
                                    style="width: 70px;">
    ...
    function loadPage(page) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#total-count-3").text(response.status_counts['3']);
    ...
    function attachTableEvents() {
        ...
        $('.view-history').click(function() {
            ...
            $.ajax({
                url: 'c_ajax_get_leave_history.php',
                type: 'POST',
                data: {
                    userCode: userCode,
