...
if ($approveStatuses) {
    ...
    if (! is_null($approveStatuses['l_approve_status2'])) {
        if ($approveStatuses['l_approve_status2'] == 1 || $approveStatuses['l_approve_status2'] == 4) {
            $updates[] = "l_approve_status2 = 4, l_approve_name2 = :proveName2, l_approve_datetime2 = :proveDate2 , l_reason2 = ''";
        } else {
...
$stmtReturn->bindParam(':proveName2', $proveName2);
$stmtReturn->bindParam(':proveDate2', $proveDate2);
